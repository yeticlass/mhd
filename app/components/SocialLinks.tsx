  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      {!open ? (
        ...
        <div className="w-[280px] rounded-2xl bg-white p-5 shadow-2xl border">
          ...
          <a
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-slate-600 px-4 py-3 text-white transition hover:bg-slate-700"
          >
            <Phone size={18} />
            {displayNumber}
          </a>
